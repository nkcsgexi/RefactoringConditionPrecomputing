	...
	public static JavaRenameProcessor getRenameProcessor(IJavaElement element) throws Exception
	 {
	         ...
	         case IJavaElement.FIELD:
	                 ...
	                 if (JdtFlags.isEnum(field))
	                         ...
	                         final RenameFieldProcessor RFprocessor= new RenameFieldProcessor
	                        		 (field);
	                         RFprocessor.setRenameGetter((flag & RenameSupport.UPDATE_GETTER_METHOD) 
	                        		 != 0);
	                         RFprocessor.setRenameSetter((flag & RenameSupport.UPDATE_SETTER_METHOD) 
	                        		 != 0);
	                         return RFprocessor;
	                 }
	         ...
	         case IJavaElement.LOCAL_VARIABLE:       
	                 ...
	                 RenameLocalVariableProcessor LVProcessor = new RenameLocalVariableProcessor
	                		 (variable);
	     ...
	     return MProcessor;
	         ...
	         case IJavaElement.TYPE_PARAMETER:
	                 ...
	                 RenameTypeParameterProcessor TPProcessor= new RenameTypeParameterProcessor
	                		 (parameter);
